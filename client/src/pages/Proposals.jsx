    ...
    <div className="space-y-6">
      ...
      <div className="card text-center py-12">
        <div className="mb-4">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-lg mb-2">No proposals yet</p>
          <p className="text-gray-400 text-sm">
            The AI will scan the market and generate buy/sell recommendations
          </p>
        </div>
        
        <div className="max-w-md mx-auto mt-6 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
